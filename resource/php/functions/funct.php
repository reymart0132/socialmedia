...
function profilePic(){
    ...
    if($view->getdpSRA()!=="" || $view->getdpSRA()!==NULL){
        echo "<img class='rounded-circle profpic2  img-thumbnail' style='height:40px;width:auto;display:inline;' alt='7' src='data:".$view->getMmSRA().";base64,".base64_encode($view->getdpSRA())."'/>";
    }else{
...
function profilePic4($id){
    $view = new view();
    if(getdp($id)!=="" || getMm($id)!==NULL){
        echo "<img  class='card-img'style='height:40px;width:auto;' src='data:".getmm($id).";base64,".base64_encode(getdp($id))."'/>";
    }else{
        echo "<img  alt='100x100' src='resource/img/user.jpg'/>";
    }
}
...
function profilePic3(){
    $view = new view();
    if($view->getdpSRA()!=="" || $view->getdpSRA()!==NULL){
        echo "<img class='card-img-left' src='data:".$view->getMmSRA().";base64,".base64_encode($view->getdpSRA())."'/>";
    }else{
        echo "<img class='card-img-left'  src='resource/img/user.jpg'/>";
    }
}
